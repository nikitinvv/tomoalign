...
if __name__ == "__main__":
    ...
    prj = np.load('/data/staff/tomograms/viknik/tomoalign_vincent_data/16nmZP/prjbin2.npy')[0:ndsets*100].astype('complex64')                                 
    theta = np.load('/data/staff/tomograms/viknik/tomoalign_vincent_data/16nmZP/theta.npy')[0:ndsets*100].astype('float32')
    ...
    for k in range(-10,10):
        ...
        with tc.SolverTomo(theta, ntheta, nz, n, pnz, (center+k)/pow(2, binning)) as tslv:
            ...
            dxchange.write_tiff_stack(
                            ucg.real,  '/data/staff/tomograms/viknik/tomoalign_vincent_data/16nmZP/cg'+'_'+str(ntheta)+'/rect'+'/r'+str((center+k)), overwrite=True)
