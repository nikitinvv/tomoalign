...
##################################### Inputs #########################################################################
file_name = '/local/data/viktor/battery/Battery_450deg_16nmZP_9100eV_2s_3000prj_interlaced_436.h5'
ndsets = 15
sino_start = 256
sino_end = 2048-256
theta_start = 0
...
if __name__ == "__main__":
   # read data
    ...
    np.save('/local/data/viktor/battery/prj436bin1',prj)        
    np.save('/local/data/viktor/battery/theta436',theta)  
