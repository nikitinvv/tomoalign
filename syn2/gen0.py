...
f = f+1*cyl(0.01,[0.4,-0.45],256,90,30,90,256)
f = f+1*cyl(0.01,[0.2,-0.25],256,-90,30,15,256)
f = f+1*cyl(0.01,[0.3,-0.15],256,-10,110,-15,256)
f[f>1]=1
f[f<0]=0
...
r = np.load('rr.npy')
fe = 0*(ndimage.filters.gaussian_filter(r, 3, truncate=8).astype('float32')-0.5)*12
