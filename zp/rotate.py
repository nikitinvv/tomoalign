...
if __name__ == "__main__":
    ...
    #mul=2
    binning=1
    data = dxchange.read_tiff_stack(in_file+'/r_00000.tiff', ind=range(0, 2048//2//2//pow(2,binning)))
    print(data.shape)
    #data = data.swapaxes(0,1)
    #data = data[:,:,(128*2)//pow(2,binning):(600*2)//pow(2,binning)]
    data = rotate(data, 18.4, reshape=False, axes=(1, 2), order=3)
    ...
    dxchange.write_tiff(data[data.shape[0]//2], in_file[:idF-1]+'results/'+in_file[idF-1:-1],overwrite=True)
