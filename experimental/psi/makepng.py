...
u = dxchange.read_tiff_stack('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/d/results_admm/u/r_00000.tiff',ind=np.arange(0,320))[10:-10,70:-70,70:-70]
ucg = dxchange.read_tiff_stack('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/d/results_cg/u/r_00000.tiff',ind=np.arange(0,320))[10:-10,70:-70,70:-70]
un = dxchange.read_tiff_stack('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/d/results_admm_reg4e-06/u/r_00000.tiff',ind=np.arange(0,320))[10:-10,70:-70,70:-70]

ucgn = dxchange.read_tiff_stack('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/TIFF_beta_ram-lak_freqscl_1.00_nonrigid_SART/tomo_delta__ram-lak_freqscl_1.00_0001.tif',ind=np.arange(1,321)).astype('float32')[10:-10,70:-70,70:-70]#.swapaxes(1,2)

vmax=-5e-4
vmin=-0.006
a=u[244];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/uz.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=u[:,u.shape[1]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/uy.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=u[:,:,u.shape[2]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/ux.png',-a,vmin=vmin,vmax=vmax,cmap='gray')

a=ucg[244];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/ucgz.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=ucg[:,ucg.shape[1]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/ucgy.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=ucg[:,:,ucg.shape[2]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/ucgx.png',-a,vmin=vmin,vmax=vmax,cmap='gray')

a=un[244];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/unz.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=un[:,ucg.shape[1]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/uny.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=un[:,:,ucg.shape[2]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/unx.png',-a,vmin=vmin,vmax=vmax,cmap='gray')

# ucg=[]
vmin=-32648/2+4000
vmax = 0
a=ucgn[244];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/upsiz.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=ucgn[:,ucg.shape[1]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/upsiy.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
a=ucgn[:,:,ucg.shape[2]//2+2];a[0]=vmin;a[1]=vmax
plt.imsave('/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/results/upsix.png',-a,vmin=vmin,vmax=vmax,cmap='gray')
