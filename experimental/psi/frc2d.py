...
f1 = dxchange.read_tiff_stack(fname1, ind = np.arange(0,320))[:].astype('float32')
f2 = dxchange.read_tiff_stack(fname2, ind = np.arange(0,320))[:].astype('float32')
f1 = f1[f1.shape[0]//2,f1.shape[1]//2-wsize:f1.shape[1]//2+wsize,f1.shape[2]//2-wsize:f1.shape[2]//2+wsize]
f2 = f2[f2.shape[0]//2,f2.shape[1]//2-wsize:f2.shape[1]//2+wsize,f2.shape[2]//2-wsize:f2.shape[2]//2+wsize]
print(f1.shape)
dxchange.write_tiff(f1,'/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/t1')
dxchange.write_tiff(f2,'/data/staff/tomograms/vviknik/tomoalign_vincent_data/psi/t2')
ff1 = np.fft.fftshift(np.fft.fft2(f1))
ff2 = np.fft.fftshift(np.fft.fft2(f2))
print(ff1.shape)
print(np.array(ff1.shape)//2)
#frc1 = np.abs(radial_profile(ff1*np.conj(ff2),np.array(ff1.shape)//2))/\
 #   np.sqrt(radial_profile(ff1*np.conj(ff1),np.array(ff1.shape)//2)*radial_profile(np.abs(ff2)**2,np.array(ff1.shape)//2))

frc1 = np.abs(sa.spinavej(ff1*np.conj(ff2)))/\
    np.sqrt(np.abs(sa.spinavej(ff1*np.conj(ff1))*sa.spinavej(ff2*np.conj(ff2))))
...
f1 = dxchange.read_tiff_stack(fname1, ind = np.arange(0,320))
f2 = dxchange.read_tiff_stack(fname2, ind = np.arange(0,320))
f1 = f1[f1.shape[0]//2,f1.shape[1]//2-wsize:f1.shape[1]//2+wsize,f1.shape[2]//2-wsize:f1.shape[2]//2+wsize]
f2 = f2[f2.shape[0]//2,f2.shape[1]//2-wsize:f2.shape[1]//2+wsize,f2.shape[2]//2-wsize:f2.shape[2]//2+wsize]
...
frc2 = radial_profile(ff1*np.conj(ff2),np.array(ff1.shape)//2)/\
    np.sqrt(radial_profile(np.abs(ff1)**2,np.array(ff1.shape)//2)*radial_profile(np.abs(ff2)**2,np.array(ff1.shape)//2))
...
f1 = dxchange.read_tiff_stack(fname1, ind = np.arange(1,321))
f2 = dxchange.read_tiff_stack(fname2, ind = np.arange(1,321))
f1 = f1[f1.shape[0]//2,f1.shape[1]//2-wsize:f1.shape[1]//2+wsize,f1.shape[2]//2-wsize:f1.shape[2]//2+wsize]
f2 = f2[f2.shape[0]//2,f2.shape[1]//2-wsize:f2.shape[1]//2+wsize,f2.shape[2]//2-wsize:f2.shape[2]//2+wsize]
...
frc3 = radial_profile(ff1*np.conj(ff2),np.array(ff1.shape)//2)/\
    np.sqrt(radial_profile(np.abs(ff1)**2,np.array(ff1.shape)//2)*radial_profile(np.abs(ff2)**2,np.array(ff1.shape)//2))
